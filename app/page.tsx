    ...
    <main className="min-h-screen overflow-hidden bg-black text-white">
      ...
      <Reveal>
        <section className="relative mx-auto grid min-h-[84vh] max-w-7xl items-center gap-16 px-6 py-16 md:grid-cols-[1fr_0.85fr]">
          ...
          <div className="relative z-10 hidden md:block">
            <div className="ml-auto w-full max-w-[470px] rounded-[3rem] border border-white/10 bg-gray-950 p-10 shadow-2xl">
      ...
      <Reveal>
        <section className="mx-auto max-w-7xl px-6 pb-32">
          <div className="overflow-hidden rounded-[3rem] border border-white/10 bg-gray-950">
            <div className="flex max-w-3xl flex-col justify-center p-8 md:p-14">
